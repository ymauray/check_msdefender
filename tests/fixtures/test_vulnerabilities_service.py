...
class TestVulnerabilitiesServiceFixtures:
    ...
    def test_get_value_by_machine_id_multiple_vulnerabilities(self):
    ...
    def test_get_value_by_machine_id_low_vulnerabilities(self):
    ...
    def test_get_value_by_machine_id_no_vulnerabilities(self):
    ...
    def test_get_value_nonexistent_machine_id(self):
        ...
        result = self.service.get_value(machine_id="nonexistent-machine")
        assert result == 0
